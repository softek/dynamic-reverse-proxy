...
DynamicProxy.prototype.createProxy = function () {
   this.proxy = new httpProxy.RoutingProxy();
   this.proxy.on("proxyError", bind(this.proxyError, this));
};

DynamicProxy.prototype.createServer = function () {
   this.server = http.createServer();
   this.server.on("request", bind(this.handleRequest, this));
};
...
DynamicProxy.prototype.listen = function () {
